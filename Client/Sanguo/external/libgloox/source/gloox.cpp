...
namespace gloox
{
  ...
  const std::string XMLNS_MSGINFO			= "http://jabber.org/protocol/msginfo";
  const std::string XMLNS_ROLEINFO			= "http://jabber.org/protocol/roleinfo";
  const std::string XMLNS_ATTRLIST			= "http://jabber.org/protocol/attrlist";
  const std::string XMLNS_PETLIST			= "http://jabber.org/protocol/petlist";
  const std::string XMLNS_ITEMDATALIST		= "http://jabber.org/protocol/itemdatalist";
