...
namespace gloox
{
  ...
  /* 添加 Msg info */
  GLOOX_API extern const std::string XMLNS_MSGINFO;

  /* 添加 Role info */
  GLOOX_API extern const std::string XMLNS_ROLEINFO;

  /* 添加 ItemData Attr */
  GLOOX_API extern const std::string XMLNS_ATTRLIST;

  /* 添加 PetData */
  GLOOX_API extern const std::string XMLNS_PETLIST;

  /* 添加 ItemData */
  GLOOX_API extern const std::string XMLNS_ITEMDATALIST;
