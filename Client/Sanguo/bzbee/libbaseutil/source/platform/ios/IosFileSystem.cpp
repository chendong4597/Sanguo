...
IosFileSystem::IosFileSystem(const tstring& rootDir, int prop, int storage, const PathRedirectCallback& cb)
...
bool IosFileSystem::getFileLocation(tstring& filePath, long& offset, long& length)
{
...
bool IosFileSystem::searchFile(const tstring & filePath)
{
    return isFile(filePath);
}

std::shared_ptr<File> IosFileSystem::openFile(const tstring & filePath, int flag)
{
...
bool IosFileSystem::deleteFile(const tstring & filePath)
{
    // delete file
    tstring fullPath = FileUtil::combinePath(m_rootDir, filePath);
...
bool IosFileSystem::isFile(const tstring & filePath)
{
    tstring fullPath = FileUtil::combinePath(m_rootDir, filePath);
...
bool IosFileSystem::isDirectory(const tstring & filePath)
{
    tstring fullPath = FileUtil::combinePath(m_rootDir, filePath);
...
bool IosFileSystem::makeDirectory(const tstring & fileDir)
{
