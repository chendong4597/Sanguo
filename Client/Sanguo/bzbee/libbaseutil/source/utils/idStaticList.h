...
*/
template<class type,int size>
FORCEINLINE idStaticList<type,size>::idStaticList() {
	num = 0;
}
...
*/
template<class type,int size>
FORCEINLINE idStaticList<type,size>::idStaticList( const idStaticList<type,size> &other ) {
	*this = other;
}
...
*/
template<class type,int size>
FORCEINLINE void idStaticList<type,size>::Clear() {
	num	= 0;
}
...
*/
template< class type,int size >
FORCEINLINE void idStaticList<type,size>::Sort( const idSort<type> & sort ) {
	if ( list == NULL ) {
		return;
	}
	sort.Sort( Ptr(), Num() );
...
*/
template<class type,int size>
FORCEINLINE void idStaticList<type,size>::DeleteContents( bool clear ) {
	int i;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::Num() const {
	return num;
}
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::Max() const {
	return size;
}
...
*/
template<class type,int size>
FORCEINLINE size_t idStaticList<type,size>::Allocated() const {
...
*/
template<class type,int size>
FORCEINLINE size_t idStaticList<type,size>::Size() const {
...
*/
template<class type,int size>
FORCEINLINE size_t idStaticList<type,size>::MemoryUsed() const {
...
*/
template<class type,int size>
FORCEINLINE void idStaticList<type,size>::SetNum( int newnum ) {
	assert( newnum >= 0 );
	assert( newnum <= size );
	num = newnum;
}
...
*/
template< class type,int size >
FORCEINLINE void idStaticList<type,size>::SetNum( int newNum, const type &initValue ) {
	assert( newNum >= 0 );
	newNum = std::min( newNum, size );
	assert( newNum <= size );
...
*/
template<class type,int size>
FORCEINLINE const type &idStaticList<type,size>::operator[]( int index ) const {
	assert( index >= 0 );
	assert( index < num );
...
*/
template<class type,int size>
FORCEINLINE type &idStaticList<type,size>::operator[]( int index ) {
	assert( index >= 0 );
	assert( index < num );
...
*/
template<class type,int size>
FORCEINLINE type *idStaticList<type,size>::Ptr() {
	return &list[ 0 ];
}
...
*/
template<class type,int size>
FORCEINLINE const type *idStaticList<type,size>::Ptr() const {
	return &list[ 0 ];
}
...
*/
template<class type,int size>
FORCEINLINE type *idStaticList<type,size>::Alloc() {
	if ( num >= size ) {
		return NULL;
	}
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::Append( type const & obj ) {
	assert( num < size );
	if ( num < size ) {
		list[ num ] = obj;
		num++;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::Insert( type const & obj, int index ) {
	int i;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::Append( const idStaticList<type,size> &other ) {
	int i;
	int n = other.Num();
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::AddUnique( type const & obj ) {
	int index;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::FindIndex( type const & obj ) const {
	int i;
...
*/
template<class type,int size>
FORCEINLINE type *idStaticList<type,size>::Find( type const & obj ) const {
	int i;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::FindNull() const {
	int i;
...
*/
template<class type,int size>
FORCEINLINE int idStaticList<type,size>::IndexOf( type const *objptr ) const {
	int index;
...
*/
template<class type,int size>
FORCEINLINE bool idStaticList<type,size>::RemoveIndex( int index ) {
	int i;
...
FORCEINLINE bool idStaticList<_type_,size>::RemoveIndexFast( int index ) {
...
*/
template<class type,int size>
FORCEINLINE bool idStaticList<type,size>::Remove( type const & obj ) {
	int index;
...
*/
template<class type,int size>
FORCEINLINE void idStaticList<type,size>::Swap( idStaticList<type,size> &other ) {
...
*/
template< class type,int size >
FORCEINLINE void idStaticList<type,size>::Resize( int newsize ) {
